...
export const TokenomicsPage = () => {
    ...
    const blocks = Math.floor(
        blocksPerHalvening - circulatingSupply.toNumber()
    );
            ...
            <div css={defaultText}>
                ...
                <div css={smallLayout}>
                    ...
                    <div css={description}>
                        ...
                        which was started on the 3rd January 2021 and then
                        halted in the middle of May so that some issues could be
                        addressed. The blockchain and all 546,113 previously
                        mined TAO were migrated to{" "}
                        <Link
                            color="#fff"
                        ...
                        which was started on 2nd November 2021 from block 0. The
                        Finney network network was officially launched on the
                        20th March 2023.
                    </div>
                    <div css={description}>
                        The total token issuance rather than the block number is
                        used to determine the exact point the halvening occurs.
                        As Tao used to recycle registrations is burned back into
                        the unissued supply, there is a lengthening halvening
                        data however this data is calculated at the current
                        block/issuance so will update automatically over time.
                    </div>
                    <div css={description}>
                        The total issuance used in Taostats is taken directly
                        from the substrate blockchain.
                    </div>
                </div>
                ...
                <div css={stakingDataBlock}>
                    ...
                    <div css={stakingDataBox}>
                        ...
                        <div css={whiteText}>
                            {formatNumber(circulationPercent, {
                                decimalPlaces: 2,
                            })}
                            %
                        </div>
                ...
                <div css={smallLayout}>
                    <div css={description}>
                        The total supply of 21 million is pre-programmed. A
                        block is mined about every 12 seconds, rewarding the
                        miners and validators with 1 TAO per block. At the
                        current inflation schedule this leads to 7200 new TAO
                        being issued into circulation every 24 hours which is
                        currently split evenly between miners and validators.
                    </div>
                    <div css={description}>
                        Once half of the supply has been issued the rate of
                        issuance is halved — with 12 seconds per block that
                        amounts to a halving every 4 years. Every half marker of
                        the remaining amount to be issued creates a new
                        halvening event until all 21 million TAO are in
                        circulation.
                    </div>
                </div>
