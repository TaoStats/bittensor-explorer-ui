...
import { BlocksOrder } from "../../services";
import { ItemsTableAttribute, ItemsTable, Time, Link } from "../elements";
    ...
    return (
        ...
        >
            ...
            <BlocksTableAttribute
                label="Events"
                sortable
                render={(block) => <>{block.eventCount}</>}
                sortProperty="eventCount"
            />
            <BlocksTableAttribute
                label="Extrinsics"
                sortable
                render={(block) => <>{block.extrinsicCount}</>}
