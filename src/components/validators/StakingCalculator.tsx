...
import { ValidatorsStakingInfoTable } from "./ValidatorsStakingInfoTable";
import { weightCopiers } from "../../consts";
import { Validator, ValidatorMovingAverageResponse } from "../../model";
        ...
        for (let i = 0; i < validators.length; i++) {
            ...
            newValis.push({
                ...
                norm30DayAvg:
                    ...
                    ret.take,
                ...ret,
                highlighted: weightCopiers.includes(
            ...
            <div css={calcLayout}>
                <div css={calcPanel}>
                    ...
                    <div css={inputLayout}>
                        <select
                            ...
                            onChange={(e) =>
                                setValidator(
                                    validators.find(
                                        (val) => val.address === e.target.value
                                    )
                                )
                            }
                        >
                    ...
                    <div css={inputLayout}>
                        <div
                            css={radioLayout}
                            onClick={() => setAsStaker(true)}
                        >
                            <div
                                css={[normalRadio, isStaker && checkedRadio]}
                            />{" "}
                            Staker
                        </div>
                        <div
                            css={radioLayout}
                            onClick={() => setAsStaker(false)}
                        >
                            <div
                                css={[normalRadio, !isStaker && checkedRadio]}
                            />{" "}
