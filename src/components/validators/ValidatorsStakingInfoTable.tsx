...
import { SortDirection, SortOrder, Validator } from "../../model";
import {
    AccountAddress,
    ItemsTable,
    ItemsTableAttribute,
...
type ValidatorsStakingInfoTableProps = {
    validators: any[];
...
export function ValidatorsStakingInfoTable(
    props: ValidatorsStakingInfoTableProps
) {
    ...
    return (
        ...
        >
            ...
            <ValidatorsStakingInfoTableAttribute
                ...
                render={({ monthlyUSD }) => {
                    return (
                        <>${formatNumber(monthlyUSD, { decimalPlaces: 2 })}</>
                    );
                }}
                sortable
            ...
            <ValidatorsStakingInfoTableAttribute
                ...
                render={({ yearlyUSD }) => {
                    return (
                        <>${formatNumber(yearlyUSD, { decimalPlaces: 2 })}</>
                    );
                }}
                sortable
