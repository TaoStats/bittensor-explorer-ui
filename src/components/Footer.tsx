                ...
                .
						...
						<div className="ft-right">
							<div className="f-col">
								...
								<ul>
									<li>
										<a href="https://chat.bitapai.io/">Chat UI</a>
									</li>
									<li>
										<a href="https://studio.bitapai.io/">Image Studio</a>
									</li>
								</ul>
								<h5>Developers</h5>
								<ul>
									<li>
										<a href="https://bitapi.io/">BitAPAI</a>
									</li>
									<li>
							...
							<div className="f-col">
								...
								<ul>
									...
									<li>
										<a href="https://x.taostats.io/#transfers">Transfers</a>
									</li>
									<li>
