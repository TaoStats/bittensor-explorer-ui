...
export function SubnetsTable(props: SubnetsTableProps) {
    ...
    return (
        ...
        >
            <SubnetsTableAttribute
                ...
                sortable
                render={(subnet) => (
                    <>{subnet.netUid && zeroPad(subnet.netUid, 2)}</>
                )}
                sortProperty="netUid"
            />
            <SubnetsTableAttribute
                ...
                render={({ emission }) =>
                    emission !== undefined && (
                        <>
                            {emission >= 100000
                                ? formatNumber(
                                      rawAmountToDecimal(emission).toNumber() *
                                          100,
                                      {
                                          decimalPlaces: 2,
                                      }
