...
export type SubnetEmissionsHistoryChartProps = {
	subnetHistory: SubnetEmissionsHistoryResponse;
};
...
export const SubnetEmissionsHistoryChart = (
	...
	const timestamps = useMemo(() => {
		...
		return subnetHistory.data
			...
			.map((x: SubnetEmissionsHistory) => x.timestamp);
	}, [subnetHistory]);
	...
	const minValue = useMemo(() => {
		return subnetHistory.data.reduce(
			(min: number, cur: SubnetEmissionsHistory) => {
	...
	const maxValue = useMemo(() => {
		return subnetHistory.data.reduce(
			(max: number, cur: SubnetEmissionsHistory) => {
