...
export const DICTIONARY_ENDPOINT = process.env.REACT_APP_DICTIONARY_ENDPOINT || "https://api.subquery.network/sq/TaoStats/nakamoto-dictionary";
export const INDEXER_ENDPOINT = process.env.REACT_APP_INDEXER_ENDPOINT || "https://api.subquery.network/sq/TaoStats/nakamoto-indexer";
